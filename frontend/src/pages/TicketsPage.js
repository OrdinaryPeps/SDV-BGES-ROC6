      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <div className="flex items-center space-x-2 whitespace-nowrap">
            ...
            />
            <Label htmlFor="today-filter" className="flex items-center gap-2 cursor-pointer whitespace-nowrap">
          ...
          <button
            onClick={toggleSound}
            className={`flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors whitespace-nowrap ${soundEnabled
